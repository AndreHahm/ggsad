...
gh pr create --title "IN-1234: Your PR title" --body "PR description"

# Create PR targeting specific branch
gh pr create --title "NOLINEAR: Feature" --body "Description" --base main --head feature-branch

# Create PR with body from file
gh pr create --title "NOLINEAR: Feature" --body-file pr-description.md
```

### PR Title Convention

- **With LINEAR ticket**: `IN-1234: Descriptive title`
- **Without LINEAR ticket**: `NOLINEAR: Descriptive title` (bypasses enforcement check)
