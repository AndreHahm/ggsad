...
Fetches title, state, author, up to 10 reviews, and the latest commit's status check rollup for a PR. See `scripts/query-pr-with-reviews.sh` for the full query.
