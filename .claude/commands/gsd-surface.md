...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Dev/Repos/ggsad/.claude/.gsd-surface.json`
(sibling to `C:/Dev/Repos/ggsad/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Dev/Repos/ggsad/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Dev/Repos/ggsad/.claude/skills`).
...
`C:/Dev/Repos/ggsad/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Dev/Repos/ggsad/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Dev/Repos/ggsad/.claude/.gsd-surface.json`
Install profile marker: `C:/Dev/Repos/ggsad/.claude/.gsd-profile`
Skill dirs: `C:/Dev/Repos/ggsad/.claude/skills/gsd-*/`
Engine module: `C:/Dev/Repos/ggsad/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Dev/Repos/ggsad/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
