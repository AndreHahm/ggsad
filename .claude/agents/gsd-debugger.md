...
<required_reading>
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Dev/Repos/ggsad/.claude
                  → checks C:/Dev/Repos/ggsad/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Dev/Repos/ggsad/.claude/gsd-core
                  → writes to C:/Dev/Repos/ggsad/.claude/gsd-core/hooks/
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-bug-taxonomy.md
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-repro-hardening.md
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-semantic-recall.md
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/thinking-models-debug.md
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-sbfl.md
...
- Read @C:/Dev/Repos/ggsad/.claude/gsd-core/references/common-bug-patterns.md
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-rca-branching.md
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-fix-acceptance.md
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@C:/Dev/Repos/ggsad/.claude/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
