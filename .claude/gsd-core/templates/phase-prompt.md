...
<!-- For checkpoint task examples and patterns, see @C:/Dev/Repos/ggsad/.claude/gsd-core/references/checkpoints.md -->
...
See `C:/Dev/Repos/ggsad/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Dev/Repos/ggsad/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/Dev/Repos/ggsad/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
