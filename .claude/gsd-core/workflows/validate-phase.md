...
```
Agent(
  prompt="Read C:/Dev/Repos/ggsad/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Dev/Repos/ggsad/.claude/gsd-core/templates/VALIDATION.md`
