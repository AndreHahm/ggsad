...
```markdown
Read C:/Dev/Repos/ggsad/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Dev/Repos/ggsad/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Dev/Repos/ggsad/.claude/agents/gsd-ui-checker.md for instructions.
...
@C:/Dev/Repos/ggsad/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / C:/Dev/Repos/ggsad/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "C:/Dev/Repos/ggsad/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "C:/Dev/Repos/ggsad/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
