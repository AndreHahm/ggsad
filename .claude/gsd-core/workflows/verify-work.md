...
<template>
@C:/Dev/Repos/ggsad/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/Dev/Repos/ggsad/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/Dev/Repos/ggsad/.claude/gsd-core/workflows/transition.md`.
...
- Follow @C:/Dev/Repos/ggsad/.claude/gsd-core/workflows/diagnose-issues.md
